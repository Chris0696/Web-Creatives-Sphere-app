    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Frontend', 'Frontend Developer'), ('Backend', 'Backend Developer'), ('Fullstack', 'Fullstack Developer'), ('Designer', 'Web Designer'), ('Copywriter', 'Web Copywriter')], max_length=50)),
                ('color', models.CharField(default='#DD7835', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='CustomerUser',
            fields=[
                ...
                ('is_author', models.BooleanField(default=False, verbose_name='Projects Author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(default='Adidas', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('grade', models.ManyToManyField(related_name='author_grades', to='users.grade')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['created'],
